...
def absoluteMonthlyRecurringEvents(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        absolute_day_of_month = req_body.get(
            "DayofMonth"
        )  # Absolute day of the month (1-31)
        ...
        event_data = {
            ...
            "recurrence": {
                "pattern": {
                    "type": "absoluteMonthly",  # Correct recurrence type
                    "interval": interval,  # Recur every X months
                    "dayOfMonth": absolute_day_of_month,  # Use dayOfMonth instead of daysOfMonth
                },
                "range": {
                    "type": "endDate",
                    "startDate": startDate,
